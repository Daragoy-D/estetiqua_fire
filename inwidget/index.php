...
try {
	...
	$inWidget->width = 1200;			// widget width in pixels
	$inWidget->inline = 6;			// number of images in single line
	$inWidget->view = 30;			// number of images in widget
	$inWidget->toolbar = true;		// show profile avatar, statistic and action button
	$inWidget->preview = 'fullsize';	// quality of images: small, large, fullsize
